...
# couriers menu
couriers = ["Deliveroo", "Just Eat", "Uber Eats"]

def couriers_menu():
    print("¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬¬")
    print("|            Couriers Menu               |")
    print("| Return                               0 |")
    print("| Print Couriers                       1 |")
    print("| Add Courier                          2 |")
    print("| Update Courier                       3 |")
    print("| Remove Courier                       4 |")
    print("|________________________________________|")
